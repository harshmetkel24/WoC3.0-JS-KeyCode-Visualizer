...
function visibility() {
    if (document.getElementById('head').style.display == 'none') {
        document.getElementById('head').style.display = 'inline-table';
...
window.addEventListener('keydown', () => {
    document.getElementById(
        'hiddenInput'
    ).value = `Code=${event.which} Key=${event.key} Location=${event.location}`;
});
function copyThis() {
    /* Get the text field */
    var copyText = document.getElementsByClassName('hiddenInput');
